...
var require_lib7 = __commonJS({
  "../find-workspace-dir/lib/index.js"(exports2) {
    ...
    async function findWorkspaceDir(cwd) {
      ...
      const workspaceManifestLocation = workspaceManifestDirEnvVar ? path_12.default.join(workspaceManifestDirEnvVar, "pnpm-workspace.yaml") : await (0, find_up_1.default)([WORKSPACE_MANIFEST_FILENAME, "pnpm-workspace.yml"], { cwd: await getRealPath(cwd) });
  ...
  "../../node_modules/.pnpm/@zkochan+libnpx@13.1.5/node_modules/@zkochan/libnpx/child.js"(exports2, module2) {
    ...
    function runCommand(command, opts) {
      ...
      return spawn(cmd, copts, {
        ...
        if (err.code === "ENOENT") {
          err = new Error(
            `npx: ${require_y()`command not found: ${path.basename(cmd)}`}`
          );
          err.exitCode = 127;
        } else {
    ...
    function spawn(cmd, args, opts) {
      ...
      return new Promise((resolve, reject) => {
        ...
        child.on("close", (code) => {
          if (code) {
            const err = new Error(
              require_y()`Command failed: ${cmd} ${args.join(" ")}`
            );
...
var require_libnpx = __commonJS({
  "../../node_modules/.pnpm/@zkochan+libnpx@13.1.5/node_modules/@zkochan/libnpx/index.js"(exports2, module2) {
    ...
    async function npx(argv) {
      ...
      if (shell || shell === "") {
        const fallback = require_auto_fallback()(
          shell,
          process.env.SHELL,
          argv
        );
    ...
    function installPackages(specs, prefix, opts) {
      ...
      return findNodeScript(opts.npm, { isLocal: true }).then((npmPath) => {
        if (npmPath) {
          args.unshift(
            process.platform === "win32" ? child.escapeArg(opts.npm) : opts.npm
          );
          return process.argv[0];
        } else {
          return opts.npm;
